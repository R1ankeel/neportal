...
| `/projects/[id]/budgets` | Бюджеты проекта: вкладки «Активные» / «Архивные», создание, архивация, totals |
...
| `/budgets/[id]` | Карточка бюджета: totals, статусы расходов, загрузка чека для `PENDING_RECEIPT` (если бюджет ACTIVE), просмотр/скачивание чеков |
