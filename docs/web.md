...
| `/tasks/[id]` | Карточка задачи: статус, проект, автор, исполнитель, дедлайн, описание, результат/причина отмены, комментарии, форма добавления |
...
- Комментарии: автор, дата, метка источника (`noteSourceLabel`: Web / Telegram / Голос Telegram).
