...
export function isVoiceMenuSelectionLike(text: string): boolean {
  ...
  const specs: Array<{ field: EditVoiceField; patterns: RegExp[] }> = [
    {
      field: "description",
      patterns: [
        /(?:^|\s)(?:добавь|добавить|допиши)\s+(?:в\s+)?(?:описани(?:е|я)|детали)(?:\s+задачи)?(?:\s*[:\-]|\s+)(.+)$/iu,
    ...
    },
    {
      field: "title",
      patterns: [
        /(?:^|\s)(?:назови)\s+задач[ауеи]?(?:\s*[:\-]|\s+)(.+)$/iu,
        /(?:^|\s)(?:добавь|добавить)\s+названи(?:е|я)(?:\s*[:\-]|\s+)(.+)$/iu,
    ...
    },
    {
      field: "deadline",
      patterns: [
        /(?:^|\s)(?:добавь|добавить)\s+(?:дедлайн|дедлайна|срок)(?:\s*[:\-]|\s+)(.+)$/iu,
    ...
    },
    {
      field: "assignee",
      patterns: [
        /(?:^|\s)(?:добавь|добавить)\s+(?:исполнител(?:я|ь)|ответственн(?:ого|ый))(?:\s*[:\-]|\s+)(.+)$/iu,
